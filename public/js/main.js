...
/* WEBPACK VAR INJECTION */(function($) {//タブの切替機能
$(function () {
  //マイページのタブ切替の処理
  ...
  var $fileInput = $('.js-file-input'); //プロフィール画像表示

  var $profImg = $('.js-prof-img'); //プロフィール画像のインプットエリアのエフェクト
  ...
  $fileInput.on('change', function (e) {
    ...
    fileReader.onload = function (event) {
      ...
      $profImg.css('background-image', 'url("' + event.target.result + '")'); // アウトプット登録画面のimg/videoのsrcへurlを直接格納
    ...
    $(this).parent().find('.prev-close').show(); //読み込んだ後、動画のみ表示順序を最上部にする

    $(this).next('video').css('z-index', '3'); // 6. 画像読み込み
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/engineertown_laravel/resources/js/main.js */"./resources/js/main.js");
